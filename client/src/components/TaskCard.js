    ...
    return (
      <div className="task" data-id={this.props.task.id}>
          ...
          <div className="task_right">
            ...
            <IconButton className="task_delete" title="Delete task" onClick={()=>{axios.delete(window.base_api_url + '/tasks/' + this.props.task.id);}}><DeleteOutlinedIcon fontSize="small"/></IconButton>
          </div>
